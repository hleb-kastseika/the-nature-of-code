...
void draw() {
    ...
    drawRectangle(
        int(map(random(0, 1), 0, 1, 1, 40)) + x1,
        int(map(random(0, 1), 0, 1, 1, 40)) + y1,
        int(map(random(0, 1), 0, 1, 1, 40)) + x2,
        int(map(random(0, 1), 0, 1, 1, 40)) + y2,
        int(map(random(0, 1), 0, 1, 1, 40)) + x3,
        int(map(random(0, 1), 0, 1, 1, 40)) + y3,
        int(map(random(0, 1), 0, 1, 1, 40)) + x4,
        int(map(random(0, 1), 0, 1, 1, 40)) + y4
    );
    if (up) {
        if (i < 25){
            i++;
